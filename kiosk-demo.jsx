...
const PRODUCTS = [
  ...
  { id: 2,  name: "Coca-Cola 0.5л",          price: 8000,  emoji: "🥤", category: "Напитки" },
  { id: 3,  name: "Red Bull 0.25л",          price: 15000, emoji: "⚡", category: "Напитки" },
  { id: 4,  name: "Сок Rich яблоко",         price: 7000,  emoji: "🍎", category: "Напитки" },
  { id: 5,  name: "Сникерс",                 price: 5000,  emoji: "🍫", category: "Снеки" },
  { id: 6,  name: "Чипсы Lays",              price: 9000,  emoji: "🥔", category: "Снеки" },
  { id: 7,  name: "Орехи ассорти",           price: 12000, emoji: "🥜", category: "Снеки" },
  { id: 8,  name: "Протеиновый батончик",    price: 18000, emoji: "💪", category: "Снеки" },
  { id: 9,  name: "Сэндвич с курицей",       price: 22000, emoji: "🥪", category: "Еда" },
  ...
  { id: 14, name: "Капучино",                price: 15000, emoji: "☕", category: "Кофе" },
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: 13, fontWeight: 700, color: "#1a1a1a" }}>
              Свежая еда и напитки — прямо здесь!
            </span>
          </div>
      ...
      {screen === "payment" && (
        <div style={{
          ...
          <div style={{ display: "flex", gap: 10, width: "100%" }}>
            ...
            <button onClick={() => { setCart([]); setScreen("success"); }} style={{
